...
#
# Derived from scheduler.py in https://github.com/metagenome-atlas/clusterprofile
# (via a simplified version authored by Derrick Lin), which is distributed under
# the MIT licence:
#
#     MIT License
#     Copyright (c) 2017 Silas Kieser
#
# See THIRD_PARTY.md at the top of this repository for details. Changes from the
# original include NCI-specific queue selection and walltime handling.
